...
public class MapDemo {
    public static void main(String[] args) {
        ...
        copies.put("ISBN-JAVA", 3); copies.put("ISBN-CLEAN", 2); copies.put("ISBN-TEST", 4);
        ...
        TreeMap<String, Integer> treeMap = new TreeMap<String, Integer>(copies);
        System.out.println(
                "Sorted snapshot: " + treeMap);
    }
}